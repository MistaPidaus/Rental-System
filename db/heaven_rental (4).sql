...
INSERT INTO `admin_user` (`admin_id`, `name`, `phone`, `email`, `password`) VALUES
(0, 'SuperUser', '0123456789', 'admin@heaven.com', '$2y$10$6S4STjUnkWzeo1LCWaA1BunGEC/fcHHOgqIbmsupRikiY4awt3woW');
...
(1, 1, 1, 72, 144000, 2000, 'Cancelled'),
(2, 1, 5, 150, 300000, 2000, 'Pending'),
(3, 1, 7, 72, 360000, 5000, 'Cancelled');
